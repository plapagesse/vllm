...
if TYPE_CHECKING:
    ...
    VLLM_FATAL_EXIT_TIMEOUT_SECONDS: int = 10
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Grace period in seconds for best-effort cleanup after a fatal
    # engine/worker error before the process force-exits, so that cleanup
    # hanging in distributed teardown cannot leave the process alive forever
    # (see https://github.com/vllm-project/vllm/issues/46509).
    "VLLM_FATAL_EXIT_TIMEOUT_SECONDS": lambda: int(
        os.getenv("VLLM_FATAL_EXIT_TIMEOUT_SECONDS", "10")
    ),
...
def compile_factors() -> dict[str, object]:
    ...
    ignored_factors: set[str] = {
        ...
        "VLLM_FATAL_EXIT_TIMEOUT_SECONDS",
